...
echo Test database should_be_ignored.txt ignored file assertion && grep -e "ignoring /docker-entrypoint-initdb.d/4-failed-should_be_ignored.txt" /log/database.log;
