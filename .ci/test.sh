...
echo Run database should_be_ignored.txt ignored file assertion; grep -e "ignoring /docker-entrypoint-initdb.d/4-should_be_ignored-failed.txt" /log/database.log && \
